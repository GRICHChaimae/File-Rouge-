    ...
    <?php foreach($Books as $Book): ?>
            <tr>
                ...
                <td>
                    ...
                    <form action="" method="post">
                        <input type="hidden" name="id" value="<?php echo $Pannel['id'] ?>">
                        <button class="updateBook" type="submit" name="deletePannelProduct">
                            <img id="pannel" src="../Images/updateBook.png" alt="">
                        </button>
                    </form>
                        <a href="modifier.html"><input type="image" src="action_ajouter.png" alt="icone_ajouter"></a>
                    </div>
                </td>
            </tr>  
        <?php endforeach;?>             
