...
if(isset($_POST['submit'])){
    $existePannel = new ProductController();
    $existePannel->UpdateExistePannel();
}
...
<?php foreach($Books as $Book): ?>
    ...
    <?php if($Book['exisitPannel'] == "false"): ?>
        <h1><?php echo $Book['exisitPannel'] ?></h1>
